	...
	public function init_view($recipes) {
		if (!isset($_SESSION['login']) || empty($_SESSION['login']))
			...
			$navButtons .=	"
				...
				<a href='index.php?module=user&action=overview' class='btn navbar-button mr-md-4'><i class='fas fa-user'></i> Account</a>
				<a href='index.php?module=connection&action=signout' id='signout-button' class='btn mr-md-4'><i class='fas fa-cog'></i> Sign out</a>";
		}
		$this->strNav = "
