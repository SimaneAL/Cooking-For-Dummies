			...
			<div class='container mt-md-5 mb-md-5 p-4 bg-white'> 
				...
				<div id='faq-container' class='container text-left'>
					<div>
						...
						<p>First thing to do: use our search engine and enter the title or keywords corresponding to your search, then click on the 'Search' button and the list of recipes corresponding to this search will be displayed. You can add filters at the <a href='#'>advanced search page</a> to have only seasonal recipes, vegetarian recipes or only desserts for example. </p>
					<div>
					<div>
